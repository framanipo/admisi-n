...
export const CarreraDetailView = ({ career, onBack }: { career: Career, onBack: () => void }) => {
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl mx-auto space-y-8 pb-12">
      ...
      <div className="bg-white rounded-[3rem] overflow-hidden shadow-2xl border border-stone-100">
        <div className="h-64 md:h-96 w-full relative">
          <img src={career.imageUrl} alt={career.name} className="w-full h-full object-cover" referrerPolicy="no-referrer" />
          <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end p-8 md:p-12">
            <h1 className="text-3xl md:text-5xl font-bold text-white leading-tight">{career.name}</h1>
          </div>
        </div>
        ...
        <div className="p-8 md:p-12 space-y-12">
          <section>
            ...
            <p className="text-stone-600 leading-relaxed text-lg">{career.fullDesc}</p>
          </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-stone-50 p-8 rounded-3xl border border-stone-100">
              ...
              <p className="text-stone-600 leading-relaxed">{career.profile}</p>
            </div>
            ...
            <div className="bg-stone-50 p-8 rounded-3xl border border-stone-100">
              ...
              <p className="text-stone-600 leading-relaxed">{career.field}</p>
            </div>
          </div>
        </div>
      </div>
