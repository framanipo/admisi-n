...
async function testQuery() {
  ...
  try {
    console.log("Testing query: SELECT id, modalidad FROM preinscripciones LIMIT 1");
    const [rows]: any = await connection.query("SELECT id, modalidad FROM preinscripciones LIMIT 1");
